...
<body class="admin-body" onload="loadAddBooks();">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-9 p-0">
                <div class="admin-header bg-white">
                    ...
                    <div class="p-3 d-flex gap-2 align-items-center">
                        <button class="btn btn-success headerbtn" onclick="addBook();" type="button"><i class="bi bi-check-circle"></i>&nbsp; Publish Book</button>
                    </div>
                </div>
                <div class="p-4 pb-0">
                    <h4>Add New Book</h4>
                            ...
                            <div class="bg-white p-4 rounded-4">
                                ...
                                <form onclick="hideAlert();">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="bookDisc" rows="6"></textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="mb-3">
                                                <label for="bookPages" class="form-label">Book Pages</label>
                                                <input type="number" class="form-control" onchange="checkInput(this)" id="bookPages" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" onchange="checkInput(this)" id="bookISBN" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="mb-3">
                                                <label for="bookPublishedDate" class="form-label">Book Published Date</label>
                                                <input type="date" class="form-control" id="bookPublishedDate" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="bookPrice" class="form-control" onchange="checkInput(this)" aria-label="Amount (to the nearest dollar)">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <span class="input-group-text">Rs.</span>
                                                <input type="number" id="bookSalePrice" class="form-control" onchange="checkInput(this)" value="00" aria-label="Amount (to the nearest dollar)">
                                                <span class="input-group-text">.00</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" onchange="checkInput(this)" id="bookQty" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                            <div class="mb-3">
                                                <label for="bookSKU" class="form-label">SKU</label>
                                                <input type="text" class="form-control" id="bookSKU" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form onclick="hideAlert();">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" id="bookWeight" onchange="checkInput(this)" class="form-control">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" id="bookDimention" onchange="checkInput(this)" class="form-control">
                            ...
                            <div class="bg-white p-4 rounded-4">
                                ...
                                <div class="">
                                    <div class="text-center align-content-center">
                                        <img class="rounded-3 border border-1" src="resourses/Upload_Book_Image.jpg" width="200px" alt="Book Image" id="bookImg">
                                    </div>
                                    <div class="text-center">
                                        <div class="file btn btn-primary mt-3" onclick="changeBookImage();">
                                            <i class="bi bi-cloud-arrow-up"></i>&nbsp; Upload Book Image
                                            <input type="file" name="file" id="bookImgUploader" />
                                        </div>
                                    </div>
                                </div>
                            </div>
