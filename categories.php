...
<body class="admin-body" onload="loadCategories();">
                        ...
                        <di class="col-12 col-lg-5 col-md-5 p-2">
                            <div class="bg-white p-4 rounded-4">
                                ...
                                <div class="text-body mb-4">
                                    <p>Categories of the books in your store can be managed here. To add Categories you can insert them below. To edit a category listed delete the category and add it again.</p>
                                </div>
                                <form onclick="hideCategoryMsg();">
                                    ...
                                    <button type="button" class="btn btn-primary w-auto col-12" onclick="addCategories();">Add New Category</button>
                                </form>
                            </div>
                        </di>
