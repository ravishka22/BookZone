...
<body class="admin-body" onload="loadAuthors();">
                        ...
                        <di class="col-12 col-lg-5 col-md-5 p-2">
                            <div class="bg-white p-4 rounded-4">
                                ...
                                <div class="text-body mb-4">
                                    <p>Authors of the books in your store can be managed here. To add author you can insert them below. To edit authors listed delete the author and add again.</p>
                                </div>
                                <form>
                                    ...
                                    <button type="button" class="btn btn-primary w-auto col-12" onclick="addAuthors ();">Add New Author</button>
                                </form>
                            </div>
                        </di>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <!-- &nbsp; -->
                                                <!-- <th scope="col"><input type="checkbox" name="select" id=""></th> -->
